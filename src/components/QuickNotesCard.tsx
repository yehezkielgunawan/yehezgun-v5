...
const QuickNotesCard = (til: QuickNotesProps) => {
	return (
		<Link
			...
			className="group rounded-lg bg-base-300 no-underline transition duration-300 hover:-translate-y-0.5 hover:underline hover:shadow-md dark:hover:shadow-neutral-content"
		>
